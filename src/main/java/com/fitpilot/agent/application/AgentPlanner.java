...
public class AgentPlanner {
    public Decision decide(String input) {
        ...
        if (contains(q, "调整计划", "修改计划", "update plan"))
            return new Decision("ADJUST_PLAN", List.of("get_user_profile", "get_workout_history", "get_personal_records", "get_training_plan", "get_training_volume", "search_knowledge", "create_training_plan"));
